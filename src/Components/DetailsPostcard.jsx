...
const DetailsPostCard = ({ post, refetch, cRefetch, comments }) => {
  ...
  const handleCommentSubmit = (e) => {
    ...
    axiosSecure.post("/add-comment", commentItem).then((res) => {
  ...
  // console.log(post)
  return (
    <div className="lg:w-7/12 mx-auto bg-white mb-10 dark:bg-[#20293d] dark:text-white shadow-lg rounded-lg p-5">
      {/* Author Section */}
      ...
      <div className="flex items-center justify-between mt-4 text-gray-600  dark:text-white dark:bg-[#20293d]">
        <div className="flex items-center space-x-1 sm:space-x-2 ">
          <div
            ...
            className="flex gap-2 btn btn-sm dark:bg-[#20293d] dark:text-white dark:hover:text-blue-500 hover:text-blue-500"
          >
            <BiSolidUpvote className="text-xl cursor-pointer h" />
            <p>UpVote · {upVote}</p>
          </div>
          <div
            onClick={() => setDawnVote(post)}
            className="flex gap-2 btn btn-sm dark:bg-[#20293d] dark:text-white dark:hover:text-blue-500 hover:text-blue-500"
          >
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          {/* comment  */}
          <Link className="flex hover:text-blue-500 items-center space-x-1">
      ...
      {/* comment section  */}
      <div className="my-10 mx-auto bg-white  dark:bg-[#20293d] dark:text-white rounded-md">
        <div className="flex items-center space-x-2 border-b pb-3 mb-3 ">
          <div className="w-11 h-11 rounded-full flex items-center justify-center">
            {user?.photoURL ? (
              ...
              <span className="text-gray-500 text-4xl rounded-full">👤</span>
            )}
          </div>
          <form
          ...
          >
            <input
              ...
              className="w-full input input-bordered text-gray-600 dark:bg-[#060817] dark:text-white bg-gray-100 p-3 rounded-md focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
            />
            <button className="bg-[#005694] hover:bg-[#005694] dark:bg-[#20293d] dark:text-white btn dark:hover:bg-[#005694] text-white px-4 py-3 rounded-md">
              Comment
            </button>
          </form>
        </div>
